<?php
	...
	$GLOBALS['translation'] = array(
		...
		'start_text' => '<p>Aeolus ist eine Plattform zum Visualisieren, Validieren und Exportieren von Umweltdaten, welche die Luftqualit&auml;t betreffen.</p><p>Diese Umweltdaten werden von einem Netzwerk verteilter Messstationen, den so genannten Air Quality Eggs &uuml;bermittelt.</p><p>Jedes Air Quality Egg ist mit Sensoren zum Messen von Kohlenstoffmonoxid (CO), Stickstoffdioxid (NO<sub>2</sub>), Temperatur und Luftfeuchtigkeit ausgestattet.</p><p>&Uuml;ber Aeolus lassen sich die Messwerte eines jeden registrierten Air Quality Eggs in einer Tabelle und als Diagramm anzeigen. Dabei kann wahlweise eine Ausrei&szlig;ererkennung zum Validieren der Messungen aktiviert werden. Zur weiteren Bearbeitung ist ein Exportieren der Daten m&ouml;glich.</p>',
