<?php
    ...
    $GLOBALS['translation'] = array(
		...
		'start_text' => 'Aeolus is a platform for visualizing, validating and exporting environmental data related to air quality. <p> This environmental data is collected and transmitted via a network of distributed stations, the so-called Air Quality Eggs. <p> Each Air Quality Egg is fitted with sensors to measure carbon monoxide (CO), nitrogen dioxide (NO<sub>2</sub>), temperature and humidity. <p> With Aeolus the readings of each registered Air Quality Eggs can be displayed as a table or chart. An outlier detection may be activated optionally in the process. For further processing it is possible to export the data.',
		...
		'sos_docu_address' => 'You can find your SOS here:',
		...
		'sos_docu_example_request' => 'The following request would return the measured data of the seonsors for CO, NO<sub>2</sub>, temperature and humidity of the Air Quality Egg with feed ID 97742 from 2013-04-02 at 07:27 AM until 2013-04-02 at 1:27 PM without outlier detection.',
